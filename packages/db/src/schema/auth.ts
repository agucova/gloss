...
import {
	commentDisplayModeEnum,
	highlightDisplayFilterEnum,
	visibilityEnum,
} from "./enums";
...
export const user = pgTable(
	"user",
	{
		...
		highlightsVisibility: visibilityEnum("highlights_visibility").default(
			"friends"
		),
		bookmarksVisibility: visibilityEnum("bookmarks_visibility").default(
			"public"
		),
		// Display preferences (what I see when browsing)
		highlightDisplayFilter: highlightDisplayFilterEnum(
			"highlight_display_filter"
		).default("friends"),
		commentDisplayMode: commentDisplayModeEnum("comment_display_mode").default(
			"collapsed"
		),
		// Admin plugin fields
...
export const userRelations = relations(user, ({ many, one }) => ({
	...
	apiKeys: many(apiKey),
	curiusCredentials: one(curiusCredentials),
